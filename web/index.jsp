  ...
  <body id="index">
    ...
    <main>
      <form action="calculate" method="post">
        ...
        <p><label for="years">Number of Years&#58;</label><input value="${investment.years}" name="years" id="years" type="text" title="Enter number of years" placeholder="Integer number of years" pattern="^[0-9]+$" required></p>
